                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    ...
                                    <p className="text-md font-medium">
                                    We create high-impact, tailored digital marketing strategies and SEO solutions that are optimized for performance, scalability, and accessibility across all platforms.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Content Creation</h2>
                                    <p className="text-md font-medium">
                                    We create high-quality, custom content—including filming, drone footage, and photography—designed for maximum impact, scalability, and wide accessibility.
                                    </p>
                                </div>
                            </div>                    
                        </div>
